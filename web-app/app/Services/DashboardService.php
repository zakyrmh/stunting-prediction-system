...
{
    /**
     * Get dashboard stats and data for Bidan role.
     */
    public function getBidanData(): array
    {
        ...
        // Certainty Factor Verification Queue
    ...
    /**
     * Get dashboard stats and data for Kader role in a specific Posyandu.
     */
    public function getKaderData(int $posyanduId): array
    {
        // 1. Balita Ditimbang Hari Ini
        $weighedToday = Prediction::where('posyandu_id', $posyanduId)
            ->whereDate('examined_at', today())
            ->count();

        // 2. Belum Hadir Bulan Ini
        ...
        // 3. Peringatan Dini: Gagal Tumbuh (2T)
        $growthFalteringCount = 0;
        ...
        // 4. Tabel Aktivitas Kunjungan Terakhir (10 entri pengukuran hari ini)
    ...
    /**
     * Get dashboard stats and data for Orang Tua role.
     */
    public function getOrangTuaData(User $user, ?int $childId): array
    {
        ...
        if ($children->isNotEmpty()) {
            $selectedChildId = $childId ?? $children->first()->id;
